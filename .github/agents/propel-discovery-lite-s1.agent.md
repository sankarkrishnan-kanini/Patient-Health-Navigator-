---
name: propel-discovery-lite-s1
description: Executes the brainstorm-idea step (S1) of a Propel discovery-lite run in an isolated context. Invoked only by the discovery-lite orchestrator with an in-progress run_id. Not for general brainstorm brief requests.
...
2. Execute it fully -- produce the brainstorm brief. All of that work stays in your
