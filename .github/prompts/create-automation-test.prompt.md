...
consult `.propel/prompts/create-automation-test.md` for the workflow steps.

---

*This generator creates comprehensive test workflows from functional requirements for Playwright automation.*
