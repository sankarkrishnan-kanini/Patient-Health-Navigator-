...
## Overview
As a Data Engineer, design a data preprocessing pipeline from the ingestion plan or source inventory. This workflow produces a preprocessing plan plus epics, user stories, and task files ready for /implement-tasks.
...
Call skill:
    - ingest_prompt(name="data-preprocessing", version="1.0")
