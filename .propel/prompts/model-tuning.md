...
## Overview
As an ML Engineer, design a hyperparameter tuning pipeline from the evaluation outputs. This workflow produces a model tuning plan with strategy and trial budget plus epics, user stories, and task files ready for /implement-tasks.
...
Call skill:
    - ingest_prompt(name="model-tuning", version="1.0")
