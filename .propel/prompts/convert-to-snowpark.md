...
## Overview
As a Data Engineer, convert Python scripts or notebooks into Snowflake Snowpark stored procedures. This workflow consults the findings registry to avoid known anti-patterns and produces validated Snowpark code.
...
Call MCP tool:
    - read_prompt(name="convert-to-snowpark", version="1.0")
