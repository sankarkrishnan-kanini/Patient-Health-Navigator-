...
## Overview
As a Data Engineer, convert Python code to Snowpark-compatible code immediately upon receiving input. This workflow produces converted code without planning artifacts.
...
Call skill:
    - ingest_prompt(name="python-to-snowpark", version="1.0")
