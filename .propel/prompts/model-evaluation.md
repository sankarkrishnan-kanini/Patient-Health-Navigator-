...
## Overview
As an ML Engineer, design a model evaluation pipeline from the training outputs. This workflow produces a model evaluation plan with optional fairness analysis plus epics, user stories, and task files ready for /implement-tasks.
...
Call skill:
    - ingest_prompt(name="model-evaluation", version="1.0")
