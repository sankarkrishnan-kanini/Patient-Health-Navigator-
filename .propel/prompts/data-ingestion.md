...
## Overview
As a Data Engineer, design a data ingestion pipeline from the DS spec or data source descriptions. This workflow produces an ingestion plan plus epics, user stories, and task files ready for /implement-tasks.
...
Call MCP tool:
    - read_prompt(name="data-ingestion", version="1.0")
