...
## Overview
As a Data Scientist, design a feature engineering pipeline from the EDA outputs. This workflow produces a feature engineering plan with selection strategy plus epics, user stories, and task files ready for /implement-tasks.
...
Call MCP tool:
    - read_prompt(name="feature-engineering", version="1.0")
