...
## Overview
As a Data Scientist, design an exploratory data analysis pipeline from the preprocessing outputs. This workflow produces an EDA plan with leakage assessment plus epics, user stories, and task files ready for /implement-tasks.
...
Call MCP tool:
    - read_prompt(name="eda", version="1.0")
