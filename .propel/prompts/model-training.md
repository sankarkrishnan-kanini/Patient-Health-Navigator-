...
## Overview
As an ML Engineer, design a model training pipeline from the feature engineering outputs. This workflow produces a model training plan with framework selection plus epics, user stories, and task files ready for /implement-tasks.
...
Call skill:
    - ingest_prompt(name="model-training", version="1.0")
