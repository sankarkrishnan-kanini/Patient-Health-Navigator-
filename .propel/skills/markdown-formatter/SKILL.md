...
description: Format markdown files against best-practice style guidelines. WHEN: "format this markdown", "clean up the readme", "standardize markdown", "fix markdown style".
license: MIT
metadata:
  author: KANINI
  version: 1.0.0
...
| | |
|---|---|
| **Best for** | Formatting markdown files to style standards |
| **Primary capabilities** | Headers · lists · code blocks · links/images · spacing · tables · validation |
| **Resources** | `resources/headers-hierarchy.md` · `resources/lists-nesting.md` · `resources/code-emphasis.md` · `resources/links-images.md` · `resources/spacing-tables.md` |
| **Scripts** | `scripts/validate-markdown.sh` |
